...
import com.poyectodamas.persistencia.exceptions.NonexistentEntityException;
...
public class UsuarioJpaController implements Serializable {
    ...
    public UsuarioJpaController(){
        emf= Persistence.createEntityManagerFactory("persistenciaDamas");
    }
    ...
    public Usuario findUsuarioByNickname(String nickname) {
        ...
        try {
            ...
            cq.where(cb.equal(root.get("nickname"), nickname));
            Query q = em.createQuery(cq);
